...
router.get('/students', async (req, res) => {
    ...
    result.prevLink = result.hasPrevPage ? `http://localhost:3000/students?page=${result.prevPage}` : '';
    result.nextLink = result.hasNextPage ? `http://localhost:3000/students?page=${result.nextPage}` : '';
